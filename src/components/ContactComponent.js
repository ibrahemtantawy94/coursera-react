...
class Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if(this.state.touched.firstname && firstname.length < 3) 
            errors.firstname = 'First name should be more than 3 charachters';
        else if (this.state.touched.firstname && firstname.length > 10)
            errors.firstname = 'First name should be less than 10 charachters';

        if(this.state.touched.lastname && lastname.length < 3) 
            errors.lastname = 'Last name should be more than 3 charachters';
        else if (this.state.touched.lastname && lastname.length > 10)
            errors.lastname = 'Last name should be less than 10 charachters';
        ...
        if(this.state.touched.telnum && !regex.test(telnum))
            ...
            errors.telnum = 'telephone number should be less than 11 numbers';
